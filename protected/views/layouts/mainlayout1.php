          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img  src="<?php echo Yii::app()->request->baseUrl; ?>/assets/themes/adminlte/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img  src="<?php echo Yii::app()->request->baseUrl; ?>/assets/themes/adminlte/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img  src="<?php echo Yii::app()->request->baseUrl; ?>/assets/themes/adminlte/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo Yii::app()->request->baseUrl; ?>/login/profil" class="btn btn-default btn-flat">Profile</a>
                    </div>
       ...
       { ?> 
            ...
            <li class="active treeview">
              <a href="<?php echo Yii::app()->request->baseUrl; ?>/manageuser">
                <i class="fa fa-dashboard"></i> <span>Kelola User</span>
              </a>
            </li>
...
<?php   }?>
            ...
            <li class="active treeview">
              <a href="<?php echo Yii::app()->request->baseUrl; ?>/downloadrekap">
                <i class="fa fa-dashboard"></i> <span>Download</span>
              </a>
            </li>
          </ul>
        </section>
